...
/obj/item/weapon/paper/proc/show_content(mob/user, forceshow)
	...
	user << browse("<HTML><meta charset=\"utf-8\"><HEAD><meta charset=\"utf-8\"><TITLE>[name]</TITLE></HEAD><BODY bgcolor='[color]'>[can_read ? info : stars(info)][stamps]</BODY></HTML>", "window=[name]")
	onclose(user, "[name]")
...
/obj/item/weapon/paper/Topic(href, href_list)
	...
	if(href_list["write"])
		...
		usr << browse("<HTML><meta charset=\"utf-8\"><HEAD><meta charset=\"utf-8\"><TITLE>[name]</TITLE></HEAD><BODY bgcolor='[color]'>[info_links][stamps]</BODY></HTML>", "window=[name]") // Update the window
...
/obj/item/weapon/paper/attackby(obj/item/weapon/P as obj, mob/user as mob)
	...
	if(istype(P, /obj/item/weapon/paper) || istype(P, /obj/item/weapon/photo))
		...
		if ( istype(RP) && RP.mode == 2 )
			...
			user << browse("<HTML><meta charset=\"utf-8\"><HEAD><meta charset=\"utf-8\"><TITLE>[name]</TITLE></HEAD><BODY bgcolor='[color]'>[info_links][stamps]</BODY></HTML>", "window=[name]")
		return
